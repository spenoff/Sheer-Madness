...
class MainMenu extends GameScene {
    ...
    create() {
        ...
        var mmtitle     = this.add.sprite(960, 200, 'titles', 0);
...
class LevelSelectMenu extends GameScene {
    ...
    create() {
        ...
        var lstitle = this.add.sprite(960, 200, 'titles', 1);
...
var config = {
    ...
    scene : [ MainMenu, LevelSelectMenu, AboutMenu, SettingMenu, Level0, Level1, Level2, Level3, Level4 ]
};
